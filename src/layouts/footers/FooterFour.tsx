...
const FooterFour = () => {
  return (
    <footer>
      {/* <div className="tg-footer-area tg-footer-space include-bg" style={{ backgroundImage: `url(/assets/img/footer/footer-2.jpg)` }}> */}
      <div className="tg-footer-area pt-130 include-bg golfnity-footer">
